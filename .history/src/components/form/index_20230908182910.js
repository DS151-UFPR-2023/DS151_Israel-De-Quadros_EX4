    ...
    return (
        ...
        <View style={styles.formContext}>
            ...
            <View>
                ...
                <TextInput style={styles.formLabel} onChangeText={setmedia1} value={media1} placeholder="Ex: 70" keyboardType="numeric"></TextInput>
                <Text style={styles.formLabel}>Nota 2</Text>
                <TextInput style={styles.formLabel} onChangeText={setmedia2} value={media2}  placeholder="Ex: 10" keyboardType="numeric"></TextInput>
